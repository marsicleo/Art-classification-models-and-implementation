...
RUN_NAME = "Tate_Collection_ViT_B16_new"
IMAGE_SIZE = (224, 224)
BATCH_SIZE = 4 
EPOCHS_PHASE1 = 3 
EPOCHS_PHASE2 = 10
...
def build_model(num_classes, unfreeze_base=False):
...
with mlflow.start_run(run_name=RUN_NAME):
    try:
        ...
        logger.info("PHASE 2")
        model = build_model(num_classes, unfreeze_base=True)
...
def build_model(num_classes=num_classes, unfreeze_base=True):
